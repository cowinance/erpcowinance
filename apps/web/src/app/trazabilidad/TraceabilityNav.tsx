...
const TABS: [string, string][] = [
  ['/trazabilidad', 'Guías'],
  ['/trazabilidad/certificaciones', 'Certificaciones'],
];

/** Navegación local del módulo Trazabilidad (T-3). Sigue el patrón de CommerceNav/FinanceNav. */
export function TraceabilityNav() {

...
Pendientes (retrospectivos, se documentan en F8 del Foundation Hardening Sprint):
`0001` Monolito Modular · `0002` PGlite y PostgreSQL · `0003` Arquitectura Offline-First.
